    ...
    <main className="h-100 flex justify-center content-center">
      <div className="p-[30px]   lg:p-[100px] flex justify-center  ">
        <div className="flex justify-center pb-10 	about	">
          ...
          <div className="flex flex-col justify-center  w-100 translateRight ps-10">
            <h1 className="text-[25px] text-3xl text-left title font-thin mt-10  md:pb-[10px] md:mt-0 ">
              Chantal Stanzione
            </h1>
