  ...
  return (
    <div className="pt-[350px] flex justify-center h-[85%] ">
      ...
      >
        ...
        <div className="pt-0 mb-3">
          <button
            className="active:bg-slate-600 hover:shadow-lg focus:outline-none px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-slate-500 rounded shadow outline-none"
            type="submit"
          >
            Send a message
          </button>
